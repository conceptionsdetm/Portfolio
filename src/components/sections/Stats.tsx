  ...
  return (
    <section className="py-20 px-6 md:px-12 bg-paper relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        <div style={{ position:"absolute", top:"10%", left:"2%", width:44, height:44, border:"1.5px solid rgba(10,10,10,0.1)", animation:"s-frot 18s ease-in-out infinite" }} />
        {/* Top-left: small dot */}
        ...
        <div style={{ position:"absolute", top:"8%", right:"3%", width:70, height:70, borderRadius:"50%", border:"1px solid rgba(10,10,10,0.09)", animation:"s-scale 12s ease-in-out infinite" }} />
        {/* Top-right: thin line */}
        ...
        {/* Bottom-right: outline circle */}
        <div style={{ position:"absolute", bottom:"8%", right:"2%", width:55, height:55, borderRadius:"50%", border:"1px solid rgba(10,10,10,0.08)", animation:"s-pulse 10s ease-in-out infinite" }} />
