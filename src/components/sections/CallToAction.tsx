  ...
  return (
    <section className="relative py-28 md:py-40 px-6 md:px-16 overflow-hidden bg-ink">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        {/* Large gold circle top-right — filled */}
        <div style={{ position:"absolute", top:"5%", right:"4%", width:130, height:130, borderRadius:"50%", background:"rgba(201,168,76,0.13)", border:"1.5px solid rgba(201,168,76,0.38)", animation:"s-pulse 14s ease-in-out infinite" }} />
        {/* Medium gold circle inside — filled */}
        <div style={{ position:"absolute", top:"9%", right:"7%", width:70, height:70, borderRadius:"50%", background:"rgba(201,168,76,0.09)", border:"1px solid rgba(201,168,76,0.28)", animation:"s-scale 10s ease-in-out infinite", animationDelay:"1.5s" }} />
        {/* Gold dot top-right */}
        ...
        <div style={{ position:"absolute", top:"18%", right:"5%", width:55, height:55, background:"rgba(208,31,43,0.2)", border:"2px solid rgba(208,31,43,0.5)", animation:"s-rotr 22s linear infinite" }} />
        ...
        {/* Mid-right: large gold square — filled */}
        <div style={{ position:"absolute", top:"40%", right:"20%", width:80, height:80, background:"rgba(201,168,76,0.09)", border:"1px solid rgba(201,168,76,0.28)", animation:"s-wag 18s ease-in-out infinite" }} />
        ...
        {/* Bottom-right: large gold circle — filled */}
        <div style={{ position:"absolute", bottom:"8%", right:"3%", width:90, height:90, borderRadius:"50%", background:"rgba(201,168,76,0.12)", border:"1.5px solid rgba(201,168,76,0.35)", animation:"s-float 11s ease-in-out infinite" }} />
